...
var auditTask = function (taskEl) {
  ...
  //aply new class if task is near/over due
...
$(".list-group").on("click", "span", function () {
  ...
  //automaticall bring up the calendar
...
$(".list-group").on("change", "input[type= 'text']", function () {
  ...
  //get status  type and positiom in the list
  var status = $(this).closets(".list-group").attr("id").replace("list-", "");
  var index = $(this).closest(".list-group-item").index();
  ...
  //recreatespan and insert in place of input element
  var taskSpan = $("<span>")
    .addClass("badge badge-promary badge-pill")
    .text(date);
  $(this).replaceWith(taskSpan);
